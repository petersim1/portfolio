...
We can use monte-carlo methods to simulate gameplay and learn an optimal policy in each iteration. So, Q values are updated every iteration, but the learned policy are only evaluated every $50,000$ iterations, to speed up training.
...
<UrlPreview url="https://github.com/petersim1/blackjack-api" landscape={true} />

<UrlPreview url="https://twitter.com/pete_sim1/status/1733308728235966793" />